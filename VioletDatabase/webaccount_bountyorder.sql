...
--
-- Table structure for table `bountyorder`
--

DROP TABLE IF EXISTS `bountyorder`;
...
--
-- Dumping data for table `bountyorder`
--

LOCK TABLES `bountyorder` WRITE;
/*!40000 ALTER TABLE `bountyorder` DISABLE KEYS */;
/*!40000 ALTER TABLE `bountyorder` ENABLE KEYS */;
UNLOCK TABLES;
